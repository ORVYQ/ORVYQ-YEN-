...
export type PrimaryEvidenceSpec = {
  ...
  eyebrow: string; title: string; subtitle?: string; callout?: string; limitation?: string; source_label: string; source_ids: string[]; evidence_asset_ids?: string[]; image_assets?: string[]; items?: EvidenceItem[]; steps?: string[]; left?: string; right?: string; left_detail?: string; right_detail?: string; focus?: EvidenceFocus; font_px?: number; presentation?: EvidencePresentation; density?: "reduced";
};
